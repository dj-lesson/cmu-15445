...
int BPlusTreePage::GetMinSize() const {
    ...
    // refer to "Database System Concepts(6th) p486"
    if (IsRootPage()) {
        // 1. root page only and empty, root page may be like this:
        // --------------------
        // Root Page
        // --------------------
        // <(empty key), child>
        ...
        // 2. root page & leaf page, this page may be like this:
        // --------------------
        // Root Page
        // --------------------
        // <(empty key), child1>, <key, child2>, ...
        // --------------------
        return IsLeafPage() ? 1 : 2;
    }

    // generally return cell( (max_size - 1) / 2 ) 
    //                  = (max_size + 1) / 2
